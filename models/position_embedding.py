...
# Code adapted form the fairseq repo.
...
class SinusoidalPositionalEmbedding(nn.Module):
    """This module produces sinusoidal positonal embeddigns of any length.
    Padding symbols are ignored, but it is necessary to specify wehter padding is added on the left side (left_pad=True) or right side (left_pad=False)."""
    ...
    def __init__(self, embedding_dim, padding_idx=0, left_pad = 0, init_size=128):
        ...
        self.register_buffer('_flaot_tensor', torch.FloatTensor(1))
